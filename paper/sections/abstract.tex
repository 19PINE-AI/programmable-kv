...
\textbf{(1) It is editable.} A salient \emph{erratum} amends the notes;
and with \emph{chain-of-thought}, editing the field alone recovers the decision ($1.00$ at
$8$B, ${\sim}1\%$ compute), while without CoT it is ignored.
\textbf{(2) It is composable.} The notes are position-portable, so a precompiled skill can be RoPE-repositioned
